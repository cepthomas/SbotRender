...
def _write_log(level, message):
    ...
    line = frame.f_lineno
    # print(f'name = {__name__}')  SublimeBagOfTricks.sbot_common_master
    # print(f'func = {frame.f_code.co_name}')  on_init
    # print(f'mod_name = {frame.f_globals["__name__"]}')  SublimeBagOfTricks.sbot
    # print(f'class_name = {frame.f_locals["self"].__class__.__name__}')
    # print(f'full_func = {class_name}.{func}')
